   ...
   private void OnTriggerEnter(Collider other){
    if(other.gameObject.tag == "Trigger"){
        ...
        for(int i = 1; i <= roadLength; i++){
            ...
            Instantiate(backgroundPrefabs[luckyNum], new Vector3(-20,0, 65 + offset), Quaternion.identity);
            Instantiate(backgroundPrefabs[luckyNum2], new Vector3(20,0, 65 + offset), Quaternion.identity);
            offset += 15;
    }
        }
